    ...
    <div class="footer py-4">
      <div class="container-fluid text-center">
        <p>
          ...
          Copyright &copy;<script data-cfasync="false" src="#"></script><script>document.write(new Date().getFullYear());</script> Gallery Gozali | Hak Cipta dibuat Oleh <a href="#" style="color: red;" target="_blank">Joshanta Gozali</a>
