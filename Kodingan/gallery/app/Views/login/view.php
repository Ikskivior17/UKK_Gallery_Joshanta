...
<input type="text" placeholder="Username" id="username" name="username" style="color: red;">

<label for="password" style="color: red;">Password</label>
<input type="password" placeholder="Password" id="password" name="password" style="color: red;">
