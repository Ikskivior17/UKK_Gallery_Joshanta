            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3" data-aos="fade">
                <form action="<?= base_url('dashboard/likePost'); ?>" method="post">
                    ...
                    <div class="interaction-section">
                        ...
                        <a href="<?= base_url('dashboard/commentForm/' . $photo->id_post); ?>" class="comment-button" style="color: red;">Comment</a>

                        <br>
                        <?php if ($photo->user_maker == session()->get('id')) : ?>
                            <!-- Display "Edit" and "Delete" buttons only if the post belongs to the logged-in user -->
                            <a href="<?= base_url('/post/editPost/' . $photo->id_post); ?>" class="edit-button" style="color: red;">Edit</a>
                            <a href="<?= base_url('/post/deletePost/' . $photo->id_post); ?>" class="delete-button" style="color: red;">Delete</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
